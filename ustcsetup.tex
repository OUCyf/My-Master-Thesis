...
\ustcsetup{
  ...
  title*             = {Uncertainty Assessment of Source Parameters and Ambient Noise Imaging Based on DAS Observation},
  author             = {尹扶},
  author*            = {Fu Yin},
  speciality         = {地质工程},
  speciality*        = {Geological Engineering},
  supervisor         = {王宝善~教授，杨微~研究员},
  supervisor*        = {Prof. Baoshan Wang，Prof. Wei Yang},
  % date               = {2017-05-01},  % 默认为今日
  professional-type  = {地质工程},
  professional-type* = {Geological Engineering},
